            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="footer-col footer-block">
                        ...
                        <div class="footer-content toggle-footer">
                            <ul>
                                <li><span>Địa chỉ:</span> 207 Giải Phóng, Đồng Tâm, Hai Bà Trưng, Hà Nội, Vietnam</li>
                                <li><span>Điện thoại:</span> +84 (035) 3621900</li>
                                <li><span>Fax:</span> +84 (035) 3621900</li>
                                <li><span>Mail:</span> dohd2201@gmail.com</li>
                            </ul>
                        </div>
                    </div>
                </div>
