...
<body>
    <div class="container">
        ...
        <div class="table-responsive">
            <form action="{{ route('online-pay') }}" id="create_form" method="post">
                @csrf
                ...
                <button type="submit" class="btn btn-primary" id="btnPopup" name="redirect">Thanh toán</button>
                <button type="submit" class="btn btn-default" onclick="history.back()">Quay lai</button>
